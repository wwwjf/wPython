...
headers = {
    ...
    'Set-Cookie': 'QINGCLOUDELB=dd91b9e2eaabd29b1d0bac5e684e6c7e466d62c936b443a78592d63b6f4b026e|Xrz5y|Xrz5y; path=/; HttpOnly',
...
def video_save(id_course, id_lesson, lesson_child):
    ...
    videoName = '{0}_{1}_{2}.mp4'.format(id_lesson, lesson_child['id'], lesson_child['name'])
